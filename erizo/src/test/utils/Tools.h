...
class PacketTools {
 public:
  ...
  static PacketPtr createNack(uint ssrc, uint source_ssrc, uint16_t seq_number,
  ...
  static PacketPtr createReceiverReport(uint ssrc, uint source_ssrc,
  ...
  static PacketPtr createSenderReport(uint ssrc, packetType type,
