...
/* VOID:UINT,UINT,UINT (..\agent\agent-signals-marshal.list:2) */
void
...
/* VOID:UINT,UINT,STRING,STRING (..\agent\agent-signals-marshal.list:4) */
void
...
/* VOID:UINT,UINT,STRING (..\agent\agent-signals-marshal.list:6) */
void
...
/* VOID:UINT (..\agent\agent-signals-marshal.list:9) */

/* VOID:UINT,UINT (..\agent\agent-signals-marshal.list:11) */
void
